...
export const site = {
  ...
  // ------------------------------------------------------------
  // Trước khi deploy: xác nhận 2 dòng dưới khớp tên repo GitHub thật.
  ...
  // ------------------------------------------------------------
  address: '147 Trần Hưng Đạo, Krông Pắc, Đắk Lắk 632700',     // Đã xác minh qua Google Maps
  openingHours: 'Mở cửa cả ngày (thứ 2 – chủ nhật)',           // Google: "Mở cửa cả ngày" cả 7 ngày
